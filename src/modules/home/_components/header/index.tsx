          ...
          <div className="flex flex-1 items-center md:items-start md:h-[300vh]">
            <div className="static top-40 flex flex-col prose justify-center py-8 md:sticky md:h-[548px]">
              ...
              <motion.ul
                  ...
                  className="list-none flex flex-col md:flex-row gap-4 mt-4"
              >
                {apps?.map((app, index) => (
                    <li key={index}>
                      <div className="flex flex-col">
                        <span className="text-sm mb-1 font-semibold">{app.name}</span>
                        {app.googlePlayLink && (
                        ...
                        {app.appStoreLink && (
                            <a href={app.appStoreLink} target="_blank" rel="noopener noreferrer">
                              <img src="/stores/app-store.svg" alt="App Store" className="h-12 mt-2"/>
                            </a>
                        )}
                      </div>
                    </li>
